...
let primary_color = localStorage.getItem('primary_color') || '#f6a419';
...
export let radial: ChartOptions = {
	...
	colors: [primary_color, secondary_color, "#51bb25", "#f6a419"],
    plotOptions: {
        radialBar: {
            dataLabels: {
                name: {
...
export let donut: ChartOptions = {
	...
	colors: ["#dc3545", "#f8d62b", primary_color, "#51bb25", "#f6a419"],
    labels: ["Team A", "Team B", "Team C", "Team D", "Team E"],
    responsive: [
        {
            breakpoint: 480,
