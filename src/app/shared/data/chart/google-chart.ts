let primary_color = localStorage.getItem('primary_color') || '#f4aa2c';
let secondary_color = localStorage.getItem('secondary_color') || '#575656';
...
export var pieChart1: any = {
  ...
  options: {
    ...
    width: '100%',
    height: 400,
	  colors: ["#f8d62b", "#51bb25", "#f6a419", secondary_color, primary_color],
...
export var pieChart4: any = {
  ...
  options: {
    ...
    // colors: ["#ab8ce4", "#26c6da"]
	  colors: ["#f8d62b", primary_color, secondary_color, "#51bb25", "#f6a419", "#dc3545", primary_color, secondary_color, "#51bb25", "#f8d62b", "#f6a419", "#dc3545", primary_color, secondary_color, "#51bb25", "#f8d62b", "#f6a419", "#dc3545", "#fd7b6c", "#51bb25", "#f8d62b", "#f6a419"],
    backgroundColor: 'transparent'
  },
};
...
export var comboChart: any = {
  ...
  options: {
    ...
    height: 500,
    fullWidth: true,
	  colors: [primary_color, secondary_color, "#51bb25", "#f6a419", "#f8d62b"],
    backgroundColor: 'transparent'
  },
};
