let primary = localStorage.getItem('primary_color') || '#f4aa2c';
let secondary = localStorage.getItem('secondary_color') || '#575656';
...
export const todayTotalSale = {
    ...
    fill: {
        ...
        gradient: {
            ...
            type: 'horizontal',
            shadeIntensity: 1,
			gradientToColors: ['#a26cf8', '#f6a419', '#f4aa2c'],
