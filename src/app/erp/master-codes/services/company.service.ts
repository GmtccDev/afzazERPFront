...
import { CompanyDto, CreateCompanyCommand, DeleteListCompanyCommand, EditCompanyCommand } from "../models/company";
...
export class CompanyServiceProxy {
    ...
    createCompany(company: CreateCompanyCommand): Observable<CompanyDto> {

        return this.http.post<any>(environment.apiUrl + "/api/Company/add?", company);
    }
    // ids: number[] | undefined;
    deleteListCompany(company: DeleteListCompanyCommand): Observable<number> {
        return this.http.post<any>(environment.apiUrl + "/api/Company/deleteList?", company);
    }
    updateCompany(company: EditCompanyCommand): Observable<CompanyDto> {
        return this.http.post<any>(environment.apiUrl + "/api/Company/edit?", company);
    }
    getDdl(): Observable<any> {
        return this.http.get<any>(this.baseUrl + "/api/Company/get-ddl?");
    }
    allCompanies(pageIndex: number | undefined, pageSize: number | undefined, sortBy: string | undefined, sortOrder: string | undefined, filter: string | undefined): Observable<any> {
    ...
    getCompany(id: any): Observable<any> {
        ...
        return this.http.get<any>(this.baseUrl + "/api/Company/getById", { params: params });
    }
    getLastCode(): Observable<any> {
        return this.http.get<any>(this.baseUrl + "/api/Company/getLastCode?");
    }
    deleteCompany(id: any): Observable<any> {
        let params = new HttpParams();
        params = params.append('id', id);
        return this.http.get<any>(environment.apiUrl + "/api/Company/delete", { params: params });
    }
