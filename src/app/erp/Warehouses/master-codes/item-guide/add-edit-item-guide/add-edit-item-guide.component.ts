...
@Component({
  selector: 'app-add-edit-item-guide',
  templateUrl: './add-edit-item-guide.component.html',
  styleUrls: ['./add-edit-item-guide.component.scss']
})
export class AddEditItemGuideComponent implements  OnInit {
  ...
  addParentUrl: string = '/warehouses-master-codes/itemGuide/add-itemGuide/';
