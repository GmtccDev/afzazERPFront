...
export class DeterminantsServiceProxy {
    ...
    allDeterminants(pageIndex: number | undefined, pageSize: number | undefined, sortBy: string | undefined, sortOrder: string | undefined, filter: string | undefined): Observable<any> {
        ...
        return this.http.get<any>(this.baseUrl + "/api/Determinants/all?", { params: queryParams });

    }


    getDeterminant(id: any): Observable<any> {
        
        let params = new HttpParams();
        params = params.append('id', id);
        return this.http.get<any>(this.baseUrl + "/api/Determinants/getById", { params: params });
    }
    getLastCode(): Observable<any> {
        return this.http.get<any>(this.baseUrl + "/api/Determinants/getLastCode?");
    }
    deleteDeterminant(id: any): Observable<any> {
        let params = new HttpParams();
        params = params.append('id', id);
        return this.http.delete<any>(environment.apiUrl + "/api/Determinants/delete", { params: params });
    }
