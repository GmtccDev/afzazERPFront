...
export class SalesPersonCommissionServiceProxy {
    ...
    allSalesPersonCommission(pageIndex: number | undefined, pageSize: number | undefined, sortBy: string | undefined, sortOrder: string | undefined, filter: string | undefined): Observable<any> {
        ...
        return this.http.get<any>(this.baseUrl + "/api/SalesPersonCommission/all?", { params: queryParams });

    }


    getSalesPersonCommission(id: any): Observable<any> {
        
        let params = new HttpParams();
        params = params.append('id', id);
        return this.http.get<any>(this.baseUrl + "/api/SalesPersonCommission/getById", { params: params });
    }
    getLastCode(): Observable<any> {
        return this.http.get<any>(this.baseUrl + "/api/SalesPersonCommission/getLastCode?");
    }
    deleteSalesPersonCommission(id: any): Observable<any> {
        let params = new HttpParams();
        params = params.append('id', id);
        return this.http.get<any>(environment.apiUrl + "/api/SalesPersonCommission/delete", { params: params });
    }
    
    deleteEntity(entity: any): Observable<any> {

        return this.http.post<any>(environment.apiUrl + "/api/SalesPersonCommission/deleteEntity?", entity);
    }
    deleteListEntity(entity: any): Observable<any> {

        return this.http.post<any>(environment.apiUrl + "/api/SalesPersonCommission/deleteListEntity?", entity);
    }
}
